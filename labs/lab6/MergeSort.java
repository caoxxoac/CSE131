...
public class MergeSort {
	...
	public static String[] createSortedArrayInRange(String[] array, int min, int maxExclusive) {
		int middle = (maxExclusive + min) / 2;
		if (min == maxExclusive-1) {
			String[] newArray = new String[1];
			newArray[0] = array[min];
			return newArray;
		}
		else {
			return mergeCombine(createSortedArrayInRange(array, min, middle), createSortedArrayInRange(array, middle, maxExclusive));
		}
	}
