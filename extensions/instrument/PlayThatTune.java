...
public class PlayThatTune {
    ...
    public static void main(String[] args) {
    	...
    	int numerator = ap.nextInt("Enter the numerator: ");
    	int denominator = ap.nextInt("Enter the denominator: ");
    	double relativeStrength = ap.nextDouble("Enter the relative strength: ");
